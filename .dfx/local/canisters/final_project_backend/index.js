...
export const canisterId = process.env.FINAL_PROJECT_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./final_project_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the final_project_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./final_project_backend.did.js")._SERVICE>}
 */
export const final_project_backend = createActor(canisterId);
