...
export const canisterId = process.env.FINAL_PROJECT_FRONTEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./final_project_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the final_project_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./final_project_frontend.did.js")._SERVICE>}
 */
export const final_project_frontend = createActor(canisterId);
